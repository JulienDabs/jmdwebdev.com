...
function MainPagefr() {
  ...
  const carolinedabadiePres = language === "fr" ? "Le premier site que j'ai créé en ligne était destiné à ma sœur. Il s'agissait d'une combinaison de langages HTML et CSS, ainsi que du framework Bootstrap pour le design. Cette expérience m'a permis de découvrir les fondamentaux de la création de sites web et m'a donné l'envie de continuer à apprendre et à perfectionner mes compétences dans ce domaine." : "The first website I created online was intended for my sister. It was a combination of HTML and CSS languages, as well as the Bootstrap framework for design. This experience allowed me to discover the fundamentals of website creation and gave me the desire to continue learning and perfecting my skills in this field." ;

  const clevercontrarianPres = language === "fr" ? "Le blog que j'ai créé pour un ami a été développé sous WordPress, l'un des CMS les plus populaires au monde. WordPress est doté d'une interface utilisateur intuitive qui facilite la création et la gestion de sites web. J'ai également développé un thème personnalisé pour le blog pour le rendre unique et adapté aux besoins spécifiques de mon ami." : "The blog I created for a friend was developed using WordPress, one of the most popular CMSs in the world. WordPress has an intuitive user interface that makes it easy to create and manage websites. I also developed a custom theme for the blog to make it unique and tailored to my friend's specific needs." ;

  const pierredabadiePres = language === "fr" ? "J'ai également créé un site vitrine pour un artiste peintre en utilisant la librairie React. Cela m'a permis d'explorer davantage le monde des frameworks JavaScript et de créer une expérience utilisateur plus dynamique et interactive pour les visiteurs du site." : "I also created a showcase website for a painter using the React library. This allowed me to further explore the world of JavaScript frameworks and create a more dynamic and interactive user experience for site visitors." ;

  const toulonmeritePres = language === "fr" ? "Je suis actuellement en train de travailler sur un blog appelé 'Toulon Mérite un Grand Sporting'. Si le site est approuvé, il sera présenté sous WordPress, un CMS populaire pour la création de blogs. J'ai hâte de partager mes avancées avec vous !" : "I am currently working on a blog called 'Toulon Mérite un Grand Sporting'. If the site is approved, it will be presented on WordPress, a popular CMS for blog creation. I look forward to sharing my progress with you!" ;

  const accomplishments = language === "fr" ? "Mes réalisations" : "My Accomplishments";
      ...
      <div className="main_page ">
          ...
          <div className="main-page-accomplishment">
            ...
            <ul className="main-page-accomplishments">
              <li className="main-page-accomplishements-detail"><h4>Caroline Dabadie | Coiffure à Domicile</h4><a href="https://www.carolinedabadie.fr"><img className="main-page-thumbnail" src={SCCaro} alt="Caroline Dabadie | Coiffure à domicile" loading="lazy" lazy="true"/></a><p>{carolinedabadiePres}</p></li>

              <li className="main-page-accomplishements-detail"><h4>The Clever Contrarian | The Daily Kaizen</h4><a href="https://www.clevercontrarian.com"><img className="main-page-thumbnail" src={SCClever} alt="Daily Kaizen" loading="lazy" lazy="true"/></a><p>{clevercontrarianPres}</p></li>

              <li className="main-page-accomplishements-detail"><h4>Pierre Dabadie | Artiste Peintre</h4><a href="https://www.pierredabadie.fr"><img className="main-page-thumbnail" src={SCDad} alt="Pierre Dabadie | Artiste peintre" loading="lazy" lazy="true"/></a><p>{pierredabadiePres}</p></li> 
